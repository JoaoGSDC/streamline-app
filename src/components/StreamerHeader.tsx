...
export const StreamerHeader = ({
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-card to-card/80 border border-primary/20 p-6 mb-6 shadow-lg">
      <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-accent/10 opacity-50" />

      <div className="relative flex flex-col sm:flex-row items-center gap-6">
        <Avatar className="h-40 w-40 border-2 border-primary shadow-[0_0_20px_rgba(145,70,255,0.5)]">
        ...
        <Button
          className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_0_20px_rgba(145,70,255,0.3)] hover:shadow-[0_0_30px_rgba(145,70,255,0.5)] transition-all duration-300 h-16 min-w-80"
