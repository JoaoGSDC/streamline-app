...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months:
          "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 w-min mx-auto",
        month: "space-y-4",
        ...
        day_selected:
          "bg-primary-container text-[hsl(var(--on-primary-container))] shadow-none hover:bg-primary-container hover:text-[hsl(var(--on-primary-container))] focus:bg-primary-container",
        day_today: "bg-secondary-container/20 text-secondary ring-1 ring-secondary-container/40",
        day_outside:
